<?php
if(!class_exists('VsiiCustomCSSOutput'))
{

    class VsiiCustomCSSOutput
    {
        static function _init()
        {
            ...
            add_action('wp_footer',array(__CLASS__,'add_ot_css'));
            add_filter( 'ot_recognized_font_families', array(__CLASS__,'ot_google_font_stack'), 1, 2 );
        }

        static function add_ot_css()
        {
            $css=self::_get_custom_css();
            wp_add_inline_style('Vsii-custom',$css);
        }
