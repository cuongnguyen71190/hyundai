<?php
if (!class_exists('VsiiOptiontree')) {
    class VsiiOptiontree
    {
        static $theme;
        ...
        {
            return "<a ><img src='" . VsiiAssets::url("admin/img/Logo.jpg") . "'></a>";
        }
        ...
        {
            return VsiiConfig::get('theme_option_menu_title');
        }
        ...
        static function _add_themeoptions()
        {
            ...
            VsiiConfig::load('theme-options');

            $custom_settings = VsiiConfig::get('theme_options', array());
        ...
        static function _ot_header_version_text()
        {
            ...
            $title .= ' - ' . sprintf(esc_html__('Version %s', "vsii-template"), self::$theme->display('Version'));


            if (class_exists('SitePress') and defined('ICL_LANGUAGE_NAME')) {
                $title .= ' ' . sprintf(esc_html__('for %s', "vsii-template"), ICL_LANGUAGE_NAME);
